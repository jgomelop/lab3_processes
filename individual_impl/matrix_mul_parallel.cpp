...
int main(int argc, char* argv[]) {
    if (argc != 4) {
        cerr << "Usage: " << argv[0] << " <matrix_A_file> <matrix_B_file> <num_processes>" << endl;
        return 1;
    }
    ...
    cout << "Using " << num_processes << " processes for parallel multiplication" << endl;
    ...
    cout << "\nPerformance Metrics (Parallel Execution with " << num_processes << " processes):" << endl;
